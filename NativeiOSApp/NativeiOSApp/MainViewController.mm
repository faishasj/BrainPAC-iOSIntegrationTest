...
UnityFramework* UnityFrameworkLoad()
{
    ...
    //[ufw sendMessageToGOWithName: "GameManager" functionName: "LoadGame" message: "BART"];
    return ufw;
}
...
- (void)initUnity
{
    ...
    if(self.showUnityOffButton == nil) {
        ...
        [self.showUnityOffButton addTarget: self action: @selector(onSessionComplete) forControlEvents: UIControlEventPrimaryActionTriggered];
